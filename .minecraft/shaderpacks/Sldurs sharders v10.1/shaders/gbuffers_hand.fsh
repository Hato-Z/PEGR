...
void main() {	
	...
	//Depth
	gl_FragData[1] = vec4(gl_FragCoord.z + pomdepthbias * 2.0f, lightmap.r, lightmap.b, alphacheck);
	...
	gl_FragData[3] = vec4(mats_1/255.0f, 0.0f, 0.0f, 1.0f);	
	
	//specularity, iswater
	//gl_FragData[3] = vec4(spec.r, spec.g, 0.0f, 1.0f);
	
	//gl_FragData[5] = vec4(lightmap.rgb, alphacheck);
