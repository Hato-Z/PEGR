...
void main() {
	...
	fogcolor.r = mix(fogcolor.r * 0.7, fogcolor.r * 0.9, rainx);
	fogcolor.g = mix(fogcolor.g * 0.65, fogcolor.g * 0.9, rainx);
	fogcolor.b = mix(fogcolor.b * 0.7, fogcolor.b * 0.9, rainx);
